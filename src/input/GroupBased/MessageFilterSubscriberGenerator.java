...
public class MessageFilterSubscriberGenerator extends MessageEventGenerator {
    /**
     ...
     */
    public MessageFilterSubscriberGenerator(Settings s) {
        super(s);
    }
    ...
    public ExternalEvent nextEvent() {
        ...
        MessageCreateFilterSubscriber mce = new MessageCreateFilterSubscriber(from, to, this.getID(),
