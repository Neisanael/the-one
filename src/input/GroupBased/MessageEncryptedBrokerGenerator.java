...
public class MessageEncryptedBrokerGenerator extends MessageEventGenerator {
    /**
     ...
     */
    public MessageEncryptedBrokerGenerator(Settings s) {
        super(s);
    }
    ...
    public ExternalEvent nextEvent() {
        ...
        MessageCreateEncryptedBroker mce = new MessageCreateEncryptedBroker(from, to, this.getID(),
