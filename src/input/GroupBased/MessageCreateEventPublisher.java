...
public class MessageCreateEventPublisher extends MessageEvent implements PropertySettings {
     ...
     */
    public MessageCreateEventPublisher(int from, int to, String id, int size,
