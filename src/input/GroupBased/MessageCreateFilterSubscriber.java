...
public class MessageCreateFilterSubscriber extends MessageEvent implements PropertySettings {
     ...
     */
    public MessageCreateFilterSubscriber(int from, int to, String id, int size,
